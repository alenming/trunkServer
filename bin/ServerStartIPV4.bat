...
start SessionServer.exe -g 1001 -ipv 0 -sg 0 -si 1 -ip 10.10.0.206 -p 5555 -connsg 1 -connsc 1 -connsg 2 -connsc 1 -connsg 3 -connsc 1 -connsg 4 -connsc 1 -connsg 5 -connsc 1 -connsg 6 -connsc 1 -chatsg 7 -chatsc 1
